            ...
            $equipamentos = mysqli_query($conn, $sql);
                ...
                while($equipamento = mysqli_fetch_array($equipamentos)){
                    echo "<tr><th>".$equipamento["id_equipamentos"]."</th>
                            <td>".strtoupper($equipamento["tipo_equip"])."</a></td>
                            <td>".strtoupper($equipamento["marca_equip"])."</td>
                            <td>".strtoupper($equipamento["modelo_equip"])."</td>
                            <td>".strtoupper($equipamento["descricao_equip"])."</td>
