<?php
    ...
    $sqlemp = "SELECT * FROM empresas WHERE id_empresas = $var_cod_int";
    $empresa = mysqli_query($conn, $sqlemp);
    ...
    $sqlserver = "SELECT COUNT(*) as totalservers
        FROM equipamentos_emp a INNER JOIN equipamentos b 
        ON a.id_equipamentos = b.id_equipamentos
        WHERE (a.id_empresas = $var_cod_int AND b.id_equipamentos = 8) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 9)
        OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 10) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 21)";
    ...
    $sqltel = "SELECT COUNT(*) as totaltel
        FROM equipamentos_emp a INNER JOIN equipamentos b 
        ON a.id_equipamentos = b.id_equipamentos
        WHERE (a.id_empresas = $var_cod_int AND b.id_equipamentos = 1) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 2)
        OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 3) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 4)
        OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 5) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 19)";
    ...
    $sqlata = "SELECT COUNT(*) as totalata
        FROM equipamentos_emp a INNER JOIN equipamentos b 
        ON a.id_equipamentos = b.id_equipamentos
        WHERE (a.id_empresas = $var_cod_int AND b.id_equipamentos = 11) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 12)
        OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 13) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 16)
        OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 18)";
    ...
    $sqlsfio = "SELECT COUNT(*) as totalsfio
        FROM equipamentos_emp a INNER JOIN equipamentos b 
        ON a.id_equipamentos = b.id_equipamentos
        WHERE (a.id_empresas = $var_cod_int AND b.id_equipamentos = 6) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 7)";
        
        $equipamento_sfio = mysqli_query($conn, $sqlsfio);
        $equipamentos_sfio = mysqli_fetch_array($equipamento_sfio);  
        
    $sqlmk = "SELECT COUNT(*) as totalmk
        FROM equipamentos_emp a INNER JOIN equipamentos b 
        ON a.id_equipamentos = b.id_equipamentos
        WHERE (a.id_empresas = $var_cod_int AND b.id_equipamentos = 14) OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 15)
        OR (a.id_empresas = $var_cod_int AND b.id_equipamentos = 17)";
        
        $equipamento_mk = mysqli_query($conn, $sqlmk);
        $equipamentos_mk = mysqli_fetch_array($equipamento_mk);    
        
    $sqlchip = "SELECT COUNT(*) as totalchip
        FROM equipamentos_emp a INNER JOIN equipamentos b 
        ON a.id_equipamentos = b.id_equipamentos
        WHERE (a.id_empresas = $var_cod_int AND b.id_equipamentos = 22)";
        
        $equipamento_chip = mysqli_query($conn, $sqlchip);
        $equipamentos_chip = mysqli_fetch_array($equipamento_chip);   

    $sqlgw = "SELECT COUNT(*) as totalgw
        FROM equipamentos_emp a INNER JOIN equipamentos b 
        ON a.id_equipamentos = b.id_equipamentos
        WHERE (a.id_empresas = $var_cod_int AND b.id_equipamentos = 20)";
        
        $equipamento_gw = mysqli_query($conn, $sqlgw);
        $equipamentos_gw = mysqli_fetch_array($equipamento_gw);   
?>
    ...
    <div class="container" style="margin-top: 6%; margin-bottom: 2%;">
                    ...
                    <div class="modal-body">
                        <div class="row" style="margin-top:3%;">
                            ...
                            <div class="form-outline mb-3 mx-4 col-3 bg-info text-white px-2" style="margin:1%">
                                ...
                                <p style="font-size: 20px"><?php echo $equipamentos_mk["totalmk"]; ?></p>
                            </div>
                        </div>
                        <div class="row">    
                            <div class="form-outline mb-3 mx-4 col-3 bg-info text-white px-2" style="margin:1%">
                                <label for="descricao"><b>TELEFONES IP</b></label>
                                <p style="font-size: 20px"><i class="bi bi-telephone-fill"></i> <?php echo $equipamentos_tel["totaltel"]; ?> </p>
                        ...
                        <div class="row">
                            <div class="form-outline mb-3 mx-4 col-3 bg-info text-white px-2" style="margin:1%">
                                <label for="descricao"><b>CHIPEIRAS</b></label>
                                <p style="font-size: 20px"><?php echo $equipamentos_chip["totalchip"]; ?></p>
                            </div>
                            <div class="form-outline mb-3 mx-2 col-3 bg-info text-white px-2" style="margin:1%">
                                <label for="descricao"><b>GATEWAY</b></label>
                                <p style="font-size: 20px"><?php echo $equipamentos_gw["totalgw"]; ?></p>
                            </div>
                        </div>      
        ...
        <?php
                ...
                if(isset($_POST["campo_pesquisa"])){
                    ...
                    $sql = "SELECT a.tipo_equip, a.marca_equip, 
                            ...
                            WHERE (a.tipo_equip LIKE '%$valor%' OR a.marca_equip LIKE '%$valor%' OR a.modelo_equip LIKE '%$valor%'
                                ...
                                OR b.patrimonio_equip LIKE '%$valor%') AND b.id_empresas = $var_cod_int";
                }	        
                ...
                while($equipamento_emp = mysqli_fetch_array($equipamentos_emp)){
                    echo "<tr><td>".strtoupper($equipamento_emp["descricao_equip"])."</td>
                        <td>".strtoupper($equipamento_emp["tipo_equip"])."</a></td>
                        <td>".strtoupper($equipamento_emp["marca_equip"])."</td>
                        <td>".strtoupper($equipamento_emp["modelo_equip"])."</td>
