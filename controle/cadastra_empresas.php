                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" style=" margin-top:2%;" id="home" role="tabpanel"
                        ...
                        <div class="row">
                            ...
                            <div class="form-outline mb-3 mx-3 col-2">
                                <label class="form-label" for="email">ID Jera <strong class="text-danger">*</strong></label>
                                <input type="number" class="form-control form-control-sm" name="id_empresas"/>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-8 mb-3">
                                        ...
                                        <select class="form-control" name="tipo_servico" id="empresa">
                                            <option>--</option>
                                            <option>Virt Dedic</option>
                                            <option>Virt Compart</option>
                                            <option>Fisico Dedic</option>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-outline col-6 mb-3">
                                        ...
                                        <textarea type="text" class="form-control form-control-sm" name="num_entrada"
                                            placeholder="Digite os números separados por vírgula"></textarea>
                                    </div>
                                    <div class="form-outline col-6 mb-3">
