    ...
    <?php // Trecho em PHP para mostrar a tabela com as empresas cadastradas
        ...
        while($empresa = mysqli_fetch_array($empresas)){
            echo "<tr><th>".$empresa["id_empresas"]."</th>
                <td>".strtoupper($empresa["descricao"])."</td>
                <!--td>".$empresa["cnpj"]."</td-->
                <td>".strtoupper($empresa["tipo_servico"])."</td>
                <td><a class='text-info' target='_blank' 
                        href='https://".$empresa["ip_pabx"]."'>".$empresa["ip_pabx"]."</a></td>
                <!--td></td-->
                <!--td></td-->
                <td>".strtoupper($empresa["cidade_emp"])."</td>
                <td>".strtoupper($empresa["estado_emp"])."</td>
                                ...
                                <div class="tab-pane fade show active" id="home'.$empresa["id_empresas"].'" 
                                    ...
                                    <div class="row" style="margin-top:3%;">
                                        ...
                                        <div class="form-outline mb-4 mx-4 col">
                                            ...
                                            <button type="button" data-confirm="ligar" class="btn btn-sm btn-success" value="Ligar"><i class="bi bi-telephone-fill"></i></button>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-outline mb-4 mx-4 col-5">
    ...
    <script>
        $(document).ready(function () {
            $("button[data-confirm]").click(function () {
                var settings = {
                "url": "https://ipbx.easytecbrasil.com.br/api/originate",
                "method": "POST",
                "timeout": 0,
                "headers": {
                    "authname": "multtenantb2b",
                    "authtoken": "754744d6c06be5e31e177541811a8ce1",
                    "Content-Type": "application/json"
                },
                "data": JSON.stringify({
                    "destination": "035998989520",
                    "key_location": " click_to_call_imedia"
                }),
                };
